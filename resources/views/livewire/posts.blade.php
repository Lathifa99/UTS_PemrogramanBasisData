...
<div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg px-4 py-4">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <input wire:model="search" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Search Data...">
                    </div>
                    </div>
                    @if($isOpen)
                ...
                <table class="table-fixed w-full">
                        <thead class="bg-gray-500">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-white w-50">Judul Buku</th>
                                <th class="px-4 py-2 text-white w-50">Deskripsi</th>
                                <th class="px-4 py-2 text-white w-50">Gambar</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (!empty($post->upload_image))
                                        <img width="100px" src="{{ url('storage/photos/'. $post->upload_image) }}" />
                                    @else
